...
一个把本机 Codex 会话投影到浏览器里的 Web UI。

它不是托管云端机器人，而是把你自己电脑上的 Codex 工作流接到网页和手机上继续使用。适合这些场景：

- 在电脑浏览器里查看和继续本机 Codex 线程
- 在手机上远程访问自己的 Codex 会话
- 上传文件给当前线程
- 可选接入语音转写
- 在 Windows 上远程触发官方 Codex Desktop 的线程刷新
